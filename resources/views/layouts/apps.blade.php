...
<head>
    ...
    <title>{{ $title }} &mdash; Stock Management</title>
        ...
        <div class="main-wrapper container">
            <div class="navbar-bg"></div>
				<nav class="navbar navbar-expand-lg main-navbar px-3">
					<a href="{{ url('dashboard') }}" class="navbar-brand sidebar-gone-hide">STOCK MANAGEMENT</a>
						...
						<ul class="navbar-nav">
							@if( Auth::user()->hasRole('supervisor') )
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="{{ url('laporan-barang-masuk') }}" class="nav-link">Barang Masuk</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ url('laporan-barang-keluar') }}" class="nav-link">Barang Keluar</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('setting-user') }}" class="nav-link"><i class="far fa-cogs"></i><span>Setting User</span></a>
                                </li>
							@endif
						</ul>
					</div>
