                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control tw-rounded-lg" wire:model='nama_kurir' id="nama_kurir">
                            </div>
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td class="p-3">{{ $row->nama_kurir }}</td>
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama_kurir">Nama Kurir</label>
                            <input type="text" wire:model="nama_kurir" id="nama_kurir" class="form-control tw-rounded-lg">
                        </div>
                    </div>
