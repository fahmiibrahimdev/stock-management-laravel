<div>
    <div class="section-header tw-rounded-lg tw-text-black tw-shadow-md">
        <h4 class="tw-text-lg">Data User</h4>
    </div>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                <label for="nama_user">Nama Karyawan</label>
                                <input type="text" class="form-control tw-rounded-lg" wire:model='nama_user' id="nama_user">
                            </div>
                            <div class="form-group">
                                <label for="id_divisi">Nama Divisi</label>
                                <div wire:ignore>
                                    <select class="form-control tw-rounded-lg" wire:model='id_divisi' id="id_divisi">
                                        @foreach ($divisis as $divisi)
                                            <option value="{{ $divisi->id }}">{{ $divisi->kode_divisi }} - {{ $divisi->nama_divisi }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div wire:ignore>
                                    <select class="form-control tw-rounded-lg" wire:model='id_jabatan' id="id_jabatan">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#id_divisi').on('change', function (e) {
                var data = $('#id_divisi').select2("val");
                @this.set('id_divisi', data);
            });
            $('#id_jabatan').on('change', function (e) {
                var data = $('#id_jabatan').select2("val");
